            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Shadow-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of Shadow-MD.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb9vh8FFCCoMRalpKU0X) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Sung544 GitHub Repo](https://github.com/Sung544/)  

🚀 _Thanks for choosing Shadow-MD — Let the automation begin!_ ✨`;
